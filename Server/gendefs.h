...
#define HOME_PURPLE_X           558
#define HOME_PURPLE_Y           542

#define CNTSAY			(TICKS)
#define MAXSAY			(TICKS*7)

#define PLR_IDLETIMER           30      // In minutes, kicks player after this time of inactivity

#define GODPASSWORD "godentrance"
