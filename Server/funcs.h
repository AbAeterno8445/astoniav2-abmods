...
void do_add_light(int x,int y,int stren,int inst_id);
...
int can_go(int x,int y,int tx,int ty,int inst_id);
int can_see(int cn,int x,int y,int tx,int ty,int maxdist,int inst_id);
int check_dlight(int x,int y,int inst_id);
void compute_dlight(int x,int y,int inst_id);
int char_id(int cn);
...
void god_goto_inst(int cn, int x, int y, int inst_id);
